...
QT_MOC_LITERAL(1, 6, 11), // "pathChanged"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 4) // "path"

    },
    "Image\0pathChanged\0\0path"
};
...
void Image::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Image::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Image::pathChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Image::staticMetaObject = {
    { &Node::staticMetaObject, qt_meta_stringdata_Image.data,
